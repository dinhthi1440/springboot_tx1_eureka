package com.example.ticketsystemservice.bean;
...
public class TicketSystemBean {
    ...
    public int getTicketResolved(){return ticketResolved;}
    public void setTicketResolved(int ticketResolved){this.ticketResolved = ticketResolved;}
